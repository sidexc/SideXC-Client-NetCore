...
namespace SideXC.WebUI.Models.Security
{
    public class Menu
    {
        private List<Option> _ListOption = new List<Option>();
        ...
        public virtual IEnumerable<Option> Options { get { return _ListOption; } }
        public void AddOptions (List<Option> list) { _ListOption.AddRange(list); }
    }
}
