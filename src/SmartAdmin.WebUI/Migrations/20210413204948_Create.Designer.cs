...
namespace SideXC.WebUI.Migrations
{
    ...
    [Migration("20210413204948_Create")]
            ...
            modelBuilder.Entity("SideXC.WebUI.Models.Inventory.MaterialType", b =>
                {
                    ...
                    b.Property<double>("MaximunRange")
                        .HasColumnType("float");

                    b.Property<double>("MinimunRange")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("SideXC.WebUI.Models.Inventory.Supplier", b =>
                {
                    ...
                    b.HasOne("SideXC.WebUI.Models.Inventory.Currency", "Currrency")
                        .WithMany()
                        .HasForeignKey("CurrrencyId");
